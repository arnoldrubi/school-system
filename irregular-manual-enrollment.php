    ...
    <div id="content-wrapper" class="col-md">
      ...
      while($row = mysqli_fetch_assoc($result))
        ...
        if (mysqli_num_rows($result_check)>0) {
           echo " | <a href=\"assign-schedule-irreg-student.php?regid=".$stud_reg_id."&student_num=".$student_number."&course=".$new_course_id."&year=".urlencode($year)."&sy=".urlencode($sy)."&term=".urlencode($term)." \">Assign Schedule</a><br>";
