            ...
            while($row = mysqli_fetch_assoc($result))
              {
                  ...
                  echo "<td class=\"options-td\"><a class=\"btn btn-success btn-sm\" href=\"classes.php?sec_id=".urlencode($row['sec_id'])."&term=".urlencode($term)."&school_yr=".urlencode($school_yr)."\">Create Classes</a>";
                  echo "</tr>";
              }
