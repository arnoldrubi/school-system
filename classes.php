    ...
    <div id="content-wrapper" class="col-md">
      ...
      <div class="card mb-3">
        <div class="card-header">
          ...
          <?php echo get_course_code($course_id,"",$connection).", ".$year.", Section ".get_section_name($sec_id,"",$connection);?>
          ...
          <div class="card-body">
            ...
            while($row = mysqli_fetch_assoc($result))
              ...
              echo "<a title=\"View Schedule\" href=\"view-schedule.php?class_id=".urlencode($row['class_id'])."\" class=\"btn btn-success btn-xs a-modal\"><i class=\"fa fa-clock-o\" aria-hidden=\"true\"></i></a>&nbsp;";
              echo "<a class=\"btn btn-warning btn-xs a-modal\" title=\"Edit\" href=\"edit-class.php?class_id=".$row['class_id']."\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i></a> <a title=\"Delete\" class=\"btn btn-danger btn-xs a-modal\" href=\"javascript:confirmDelete('delete-class.php?class_id=".$row['class_id']."')\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></a></td>";
              echo "</tr>";
              }
