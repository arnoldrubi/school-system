        ...
        <div class="col-md-5 center-block-e" style="margin: auto">
          <p class="login-form-intro"><img width="100" height="100" src="<?php echo "uploads/".$site_logo; ?>"></p>
            <div class="card-body">
              ...
              <p>A reset password link will be sent to your email.<br>
                <a href="https://fcat.com.ph/aims">Back to login</a></p>
              ...
              <?php
                ...
                if(isset($_POST["reset-request-submit"]))
                {
                  ...
                  $subject = "AIMS Account Reset";

                  $message = "<p>Your password has been reset. Below are your credentials:</p>";
