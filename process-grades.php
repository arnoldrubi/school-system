...
//loop through values of the input arrays
	...
	if ($result === TRUE) {
         ...
         $URL= "encode-grades.php?subject_id=".urlencode($subject_id)."&term=".urlencode($term)."&course_id=".urlencode($course_id)."&year=".urlencode($year)."&section=".urlencode($section)."&teacher_id=".urlencode($teacher_id)."&grade_saved=1";
...
//loop through values of the input arrays
	...
	if ($result === TRUE) {
         ...
         $URL= "encode-grades.php?subject_id=".urlencode($subject_id)."&term=".urlencode($term)."&course_id=".urlencode($course_id)."&year=".urlencode($year)."&section=".urlencode($section)."&teacher_id=".urlencode($teacher_id)."&grade_saved=2";
         echo "<script>location.href='$URL'</script>";
...
//loop through values of the input arrays
	...
	if ($result === TRUE) {
         ...
         $URL= "encode-grades.php?subject_id=".urlencode($subject_id)."&term=".urlencode($term)."&course_id=".urlencode($course_id)."&year=".urlencode($year)."&section=".urlencode($section)."&teacher_id=".urlencode($teacher_id)."&grade_saved=0";
         echo "<script>location.href='$URL'</script>";
